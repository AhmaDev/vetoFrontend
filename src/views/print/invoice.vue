<template>
  <div ref="print" id="homePage" class="pa-10">
    ...
    <v-sheet v-if="invoice.items[0] != null" style="margin-bottom: 20px" color="white" :key="invoice.idInvoice" class="pa-10 sheet" elevation="4">
      <table class="table" border="1" cellspacing="0" width="100%">
          ...
          <tr>
              ...
              <td>وقت وتاريخ : {{invoice.creationFixedDate}} - {{invoice.creationFixedTime}}</td>
          </tr>
      </table>
      <br>
      <table class="table" border="1" cellspacing="0" width="100%">
...
export default {
  ...
  created: function () {
    ...
    this.$http.post(this.$baseUrl + 'invoice/multiple', {
